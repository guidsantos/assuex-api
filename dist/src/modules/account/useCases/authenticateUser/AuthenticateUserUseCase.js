...
var AuthenticateUserUseCase = /** @class */ (function () {
    ...
    AuthenticateUserUseCase.prototype.execute = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var user, authenticate, _b, secret, expiresIn, token, responseUser;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        user = _c.sent();
                        if (!user) {
                            throw new AppError_1["default"]("user don't exists", 400);
                        }
                        authenticate = (0, bcrypt_1.compare)(password, user.password);
                        if (!authenticate) {
                            throw new AppError_1["default"]("invalid login", 400);
                        }
                        ...
                        responseUser = { name: user.name, email: user.email };
                        return [2 /*return*/, {
